...
<body>
    ...
    <ul>
        <li><a class="btn btn-primary mindway-btn" href="{{$resetLink}}">Set Up Admin Profile</a></li>
        <li><a class="btn btn-primary mindway-btn" href="{{route('login')}} ">Log In to Admin Portal</a></li>
    </ul>
